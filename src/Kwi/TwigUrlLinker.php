...
Class TwigUrlLinker extends Twig_Extension {
    ...
    {
        return array(
            new Twig_SimpleFilter('UrlLinker', array($this, 'htmlEscapeAndLinkUrls')),
            new Twig_SimpleFilter('UrlLinkerTrusted', array($this, 'linkUrlsInTrustedHtml')),
        );
    }
    ...
    {
        /*
         *  Regular expression bits used to match URLs.
         */
        $rexScheme    = 'https?://';
